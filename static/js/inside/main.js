mbe = {
	...
	init: {
		...
		header: function() {
            ...
            $('.page .header .secondary-menu a.help-menu-link').click(function(e){
                e.preventDefault();
                _kmq.push(['record', 'Help menu click']);
	...
	mobile: {
		...
		ipad: {
			ready: function() {
				...
				//add the ipad css
				$('head')
					.append('<link rel="stylesheet" type="text/css" href="../static/css/ipad.css" />')
					.append('<script type="text/javascript" src="../static/js/iscroll/iscroll.js"></script>')
		...
		iphone: {
			...
			ready: function() {
				...
				//add the ipad css
				$('head')
					.append('<link rel="stylesheet" type="text/css" href="../static/css/iphone.css" />')
					.append('<script type="text/javascript" src="../static/js/iscroll/iscroll.js"></script>')
					.append('<script type="text/javascript" src="../static/js/jquery.truncate.min.js"></script>')
